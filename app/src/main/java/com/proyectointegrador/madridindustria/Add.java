        ...
        enviar.setOnClickListener(v -> {
            ...
            if (!coordenadas_latText.isEmpty() && !coordenadas_lonText.isEmpty()) {
                ...
                if (coordenadas_latText.isEmpty()) {
                    ...
                    coordenadas_latEditText.setOnFocusChangeListener((v1, hasFocus) -> {
                        if(!hasFocus){
                ...
                if (coordenadas_lonText.isEmpty()) {
                    ...
                    coordenadas_lonEditText.setOnFocusChangeListener((v12, hasFocus) -> {
                        if(!hasFocus){
            ...
            if (!imagenText.isEmpty() && !nombreText.isEmpty() && !inaguracionText.isEmpty() && !patrimonioText.isEmpty() && !metroText.isEmpty() && !direccionText.isEmpty() && !descripcionText.isEmpty() && !dist.isEmpty()) {
                ...
                if (imagenText.isEmpty()) {
                    ...
                    imagenEditText.setOnFocusChangeListener((v13, hasFocus) -> {
                        if(!hasFocus){
                ...
                if (nombreText.isEmpty()) {
                    ...
                    nombreEditText.setOnFocusChangeListener((v14, hasFocus) -> {
                        if(!hasFocus){
                ...
                if (inaguracionText.isEmpty()) {
                    ...
                    inaguracionEditText.setOnFocusChangeListener((v15, hasFocus) -> {
                        if(!hasFocus){
                ...
                if (patrimonioText.isEmpty()) {
                    ...
                    patrimonioEditText.setOnFocusChangeListener((v16, hasFocus) -> {
                        if(!hasFocus){
                ...
                if (metroText.isEmpty()) {
                    ...
                    metroEditText.setOnFocusChangeListener((v17, hasFocus) -> {
                        if(!hasFocus){
                ...
                if (direccionText.isEmpty()) {
                    ...
                    direccionEditText.setOnFocusChangeListener((v18, hasFocus) -> {
                        if(!hasFocus){
                ...
                if (descripcionText.isEmpty()) {
                    ...
                    descripcionEditText.setOnFocusChangeListener((v19, hasFocus) -> {
                        if(!hasFocus){
