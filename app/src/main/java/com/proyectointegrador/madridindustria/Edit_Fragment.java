...
public class Edit_Fragment extends Fragment {
    ...
    private TextInputLayout imagenInputLayout, descripcionInputLayout;
    private Spinner distritoT;
    private String dist = "", dis = null, distSelec = null;
        ...
        nombreTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < adapter.getCount(); i++) {
                    String distritoA = adapter.getItem(i).toString();
                            ...
                            FirebaseFirestore.getInstance().collection(dis)
                                    ...
                                    .addOnCompleteListener(task -> {
                                        if (task.isSuccessful()) {
                                            ...
                                            showErrorDialog("El patrimonio no existe.");
                                        }
                                    });
                        } else {
                            if(dist.isEmpty()){
                                distritoT.setBackground(redBorderDrawable);
                            }
                            marcarError(firestoreDatabase.getImagen().toString(), imagenInputLayout, R.string.ima, imagenEditText);
                            marcarError(firestoreDatabase.getDescripcion().toString(), descripcionInputLayout, R.string.des, descripcionEditText);
                        }
                    }
                });
